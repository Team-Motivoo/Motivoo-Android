package sopt.teammotivoo.presentation.auth
...
import sopt.teammotivoo.databinding.FragmentLoginBinding
import sopt.teammotivoo.domain.entity.MotivooStorage
import sopt.teammotivoo.presentation.invitecode.GetInviteCodeFragment
        ...
        authViewModel.navigationEvent.flowWithLifecycle(
            ...
            .onEach { event ->
                when (event) {
                    ...
                    NavigationEvent.Description -> findNavController().navigate(R.id.action_loginFragment_to_descriptionFragment)
